...
const Posts = async () => {
  ...
  return (
    <div className='max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-10 py-10 px-10'>
      {
        data.posts.map((item) => (
          <div key={item.id} className='flex flex-col border py-2 rounded'>
            <p className=' px-4 py-2'>User ID: {item.userId}</p>
            ...
            <div className='flex justify-center bg-[#23A6F0] text-white py-2 font-bold'>
