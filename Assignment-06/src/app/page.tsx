...
const mainPage = () => {
    ...
    <div>
        ...
        <section className="w-[1280px] flex max-md:w-[768px] max-md:flex-col">
            <div className="w-[720px] flex flex-col justify-center pl-[80px] pr-[60px] max-md:px-6 max-md:w-[768px] max-md:py-[100px] max-md:gap-[24px]">
                <div className="w-[580px] flex flex-col max-md:w-[720px] max-md:gap-[24px]">
        ...
        <section className="w-[1280px] bg-[#F7F7F7] flex items-center justify-between py-[64px] max-md:w-[768px] max-md:px-6 max-md:block max-md:bg-white max-md:block">
            ...
            <div className="max-md:w-[768px] max-md:mt-[24px] max-md:truncate max-md:py-[16px]">
        ...
        <section className="w-[1280px] flex flex-col items-center justify-center gap-[64px] py-[64px] max-md:w-[768px]">
            <div className="w-[768px] max-md:px-6 max-md:text-center">
            ...
            <div className="main max-md:flex max-md:flex-col max-md:gap-6">
                <div className="bg-[#F7F7F7] w-[410px] flex items-center p-[16px] gap-[32px] max-md:w-[720px]">
                ...
                <div className="bg-[#F7F7F7] w-[410px] flex items-center p-[16px] gap-[32px] max-md:w-[720px] max-md:w-[720px]">
        ...
        <section className="border w-[1280px] flex flex-col items-center justify-center gap-[64px] py-[64px] max-md:w-[768px]">
            <div className="w-[1152px] flex flex-col items-center gap-[16px] max-md:w-[768px] max-md:w-[720px]">
                <h1 className="text-[48px] font-bold">Our Achivements</h1>
                <p className="text-center max-md:w-[720px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat.</p>
            </div>
            <div className="achivements w-[1280px] flex items-center justify-center gap-[24px] max-md:w-[720px]">
        ...
        <section className="w-[1280px] flex flex-col items-center justify-center gap-[64px] py-[64px] mt-[64px] max-md:w-[768px] max-md:hidden">
            <div className="w-[1152px] flex flex-col items-center gap-[16px] max-md:w-[720px]">
                <h1 className="text-[48px] font-bold">Our Achivements</h1>
            ...
            <div className="achivements w-[1280px] flex items-center justify-center gap-[24px] max-md:w-[720px]">
                ...
                <div className="w-[296px] max-md:w-[720px]">
                    <h1 className="text-center text-[40px] font-bold">+50k</h1>
                    <p className="text-center">Menotrs</p>
                </div>
                <div className="w-[296px] max-md:w-[720px]">
        ...
        <section className="w-[1280px] flex flex-col items-center justify-center gap-[64px] py-[64px] mt-[64px] max-md:w-[768px]">
            <div className="w-[1152px] flex flex-col items-center gap-[16px] max-md:w-[720px]">
                <h1 className="text-[56px] font-bold">Courses</h1>
                <p className="text-center text-[18px]">Your Ultimate Guide to learning</p>
            </div>
            <div className="w-[336px] flex flex-col items-center gap-[16px] max-md:w-[720px]">
                <ul className="flex">
            ...
            <div className="courses max-md:w-[720px] max-md:block">
                <div className="w-[416px] bg-[#F7F7F7] flex flex-col gap-[24px] max-md:w-[720px] max-md:my-4">
                    <div className="max-md:w-[720px]">
                        <Image className="max-md:w-[720px]" src={"/images/c-image-1.svg"} alt={"image"} width={"416"} height={"300"}/>
                    </div>
                ...
                <div className="w-[416px] bg-[#F7F7F7] flex flex-col gap-[24px] max-md:w-[720px] max-md:my-4">
                    <div>
                        <Image className="max-md:w-[720px]" src={"/images/c-image-2.svg"} alt={"image"} width={"416"} height={"300"}/>
                    </div>
                    <div className="flex flex-col gap-[24px] p-4 max-md:w-[720px]">
                        <div className="flex justify-between text-[14px] font-medium">
                ...
                <div className="w-[416px] bg-[#F7F7F7] flex flex-col gap-[24px] max-md:w-[720px] max-md:my-4">
                    <div>
                        <Image className="max-md:w-[720px]" src={"/images/c-image-3.svg"} alt={"image"} width={"416"} height={"300"}/>
                    </div>
                    <div className="flex flex-col gap-[24px] p-4 max-md:w-[720px]">
                        <div className="flex justify-between text-[14px] font-medium">
                            <span>Business</span>
                ...
                <div className="w-[416px] bg-[#F7F7F7] flex flex-col gap-[24px] max-md:w-[720px] max-md:my-4">
                    <div>
                        <Image className="max-md:w-[720px]" src={"/images/c-image-4.svg"} alt={"image"} width={"416"} height={"300"}/>
                    </div>
                    <div className="flex flex-col gap-[24px] p-4 max-md:w-[720px]">
                        <div className="flex justify-between text-[14px] font-medium">
                            <span>Art</span>
                ...
                <div className="w-[416px] bg-[#F7F7F7] flex flex-col gap-[24px] max-md:w-[720px] max-md:my-4">
                    <div>
                        <Image className="max-md:w-[720px]" src={"/images/c-image-5.svg"} alt={"image"} width={"416"} height={"300"}/>
                    </div>
                    <div className="flex flex-col gap-[24px] p-4 max-md:w-[720px]">
                        <div className="flex justify-between text-[14px] font-medium">
                            <span>Law</span>
                ...
                <div className="w-[416px] bg-[#F7F7F7] flex flex-col gap-[24px] max-md:w-[720px] max-md:my-4">
                    <div>
                        <Image className="max-md:w-[720px]" src={"/images/c-image-6.svg"} alt={"image"} width={"416"} height={"300"}/>
                    </div>
                    <div className="flex flex-col gap-[24px] p-4 max-md:w-[720px]">
                        <div className="flex justify-between text-[14px] font-medium">
                            <span>Tech</span>
        ...
        <section className="w-[1280px] bg-[#F7F7F7] flex flex-col items-center justify-center gap-[64px] py-[64px] mt-[64px] max-md:w-[768px]">
        ...
        <section className="hidden w-[1280px] bg-[#F7F7F7] flex flex-col items-center justify-center gap-[64px] py-[64px] max-md:block max-md:w-[768px] max-md:bg-white max-md:px-6">
            <div className="w-[1152px] flex flex-col gap-[16px] max-md:w-[720px] max-md:items-center">
                <h1 className="text-[48px] font-bold">What Our Student Say</h1>
                <p className="text-[18px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            <div className="flex flex-col gap-[48px] max-md:w-[768px]  max-md:mt-8">
                <div className="flex gap-[32px] w-[1152px] max-md:w-[720px]">
                    <div className="border border-black p-[32px] w-[362px] flex flex-col gap-[32px] max-md:w-[720px]">
                        <ul className="flex gap-2">
                            <li><Image src={"/images/black-star.svg"} alt={"image"} width={"20"} height={"18"}/></li>
                            <li><Image src={"/images/black-star.svg"} alt={"image"} width={"20"} height={"18"}/></li>
                            <li><Image src={"/images/black-star.svg"} alt={"image"} width={"20"} height={"18"}/></li>
                        ...
                        <div className="w-[298px] flex flex-col gap-[24px] max-md:w-[720px]">
                            <p className="max-md:w-[440px]">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare."</p>
                            <span className="flex items-center gap-[20px]">
                                <Image src={"/images/profile3.svg"} alt={"image"} width={"56"} height={"56"} className="rounded-[50%]"/>
                                <span>
                                    <h3 className="text-[16px] font-semibold">James Nduku</h3>
                ...
                <div className="flex justify-between gap-[32px] w-[1152px] max-md:w-[720px]">
                    <div className="flex items-center">
                        <Image src={"/images/slider-dots.svg"} alt={"image"} width={"72"} height={"8"}/>
                    </div>
                    <div className="flex gap-[15px]">
